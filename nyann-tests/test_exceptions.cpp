...
namespace {
	...
	TEST(FrameworkExceptions, SizeError)
	{
		try
		{
			throw nyann::SizeError("Error");
		}
		catch (nyann::SizeError & e)
		{
			EXPECT_EQ(std::string(e.what()), "Error");
		}
	}
	...
	TEST(FrameworkExceptions, ConstParentError)
	{
		try
		{
			throw nyann::ConstParentError("Error");
		}
		catch (nyann::ConstParentError & e)
		{
			EXPECT_EQ(std::string(e.what()), "Error");
		}
	}

	TEST(FrameworkExceptions, DeprecationError)
	{
		try
		{
			throw nyann::DeprecationError("Error");
		}
		catch (nyann::DeprecationError & e)
		{
			EXPECT_EQ(std::string(e.what()), "Error");
		}
	}
